class Bintree:
    ...
    def __putta(self, p, value):
        ...
        if p == None:
            ...
            p.setLeft(self.__putta(p.getLeft(), value))  # Lägger till värdet i vänstra underträdet
        elif value > p.getVal():
            p.setRight(self.__putta(p.getRight(), value))  # Lägger till värdet i högra underträdet
        return p
...
class Node:
    def __init__(self, data):
        self.__data = data  # Lagrar nodens data
        self.__left = None  # Vänster barn
        self.__right = None  # Höger barn

    def getVal(self):
        return self.__data  # Hämtar nodens värde

    def getLeft(self):
        return self.__left  # Hämtar vänster barn

    def getRight(self):
        return self.__right  # Hämtar höger barn

    def setLeft(self, left):
        self.__left = left  # Sätter vänster barn

    def setRight(self, right):
        self.__right = right  # Sätter höger barn
